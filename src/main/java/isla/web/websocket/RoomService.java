...
public class RoomService {
    ...
    public void sendComment(@Payload CommentDTO commentDTO, @DestinationVariable("lecture") int lecture) {
        ...
        messagingTemplate.convertAndSend("/topic/room/" + lecture, commentDTO);
    }
}
